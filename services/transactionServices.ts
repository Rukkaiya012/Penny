...
export const fetchMonthlyStats = async (
    uid: string    
        ...
        try{            
            ...
            //Process transaction to calculate income and expense for each month
            querySnapshot.forEach((doc)=>{
                const transaction = doc.data() as TransactionType;
    ...
    uid: string    
        ...
        try{            
            ...
            querySnapshot.forEach((doc)=>{
                ...
                //Reformat yearlyData for the bar chart with income and expense entries for each month
